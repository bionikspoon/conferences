...
clean-docs:
	rm -f $(DOCSSOURCEDIR)/conferences.rst
...
coverage:
	coverage run conferences setup.py test
	coverage report
	coverage html
...
builddocs:
	...
	sphinx-apidoc \
		...
		--no-toc \
		--module-first \
		--output-dir=$(DOCSSOURCEDIR)/ conferences
	$(MAKE) -C docs html
...
servedocs: docs
	...
	watchmedo shell-command \
		...
		--ignore-pattern '$(DOCSBUILDDIR)/*;$(DOCSSOURCEDIR)/conferences.rst' \
		--ignore-directories \
		--recursive
